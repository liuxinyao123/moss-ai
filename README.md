...
前提：本机已安装 **Node.js**、**pnpm**、并且有可运行的 **ClawX 源码目录**。

```bash
git clone https://github.com/liuxinyao123/DSClaw.git
cd DSClaw
npm install
./start.sh
```
...
2. 在 **与 `moss-ai` 同级的 `../ClawX/`** 启动 `pnpm dev`（GUI）
