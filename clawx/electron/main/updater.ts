...
/**
 * Lazily create the updater after Electron main is alive.
 * Eager `new AppUpdater()` at module load breaks dev builds where the bundle
 * is evaluated under plain Node (electron-updater touches `app` immediately).
 */
