...
import dsclawIcon from '@/assets/dsclaw-icon.svg';
...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { to: '/experts', icon: <GraduationCap className="h-[18px] w-[18px]" strokeWidth={2} />, label: '专家', testId: 'sidebar-nav-experts' },
    { to: '/moss', icon: <MonitorPlay className="h-[18px] w-[18px]" strokeWidth={2} />, label: 'Moss', testId: 'sidebar-nav-moss' },
  ];
      ...
      <div className={cn("flex items-center p-2 h-12", sidebarCollapsed ? "justify-center" : "justify-between")}>
        {!sidebarCollapsed && (
          <div className="flex items-center gap-2 px-2 overflow-hidden">
            <img src={dsclawIcon} alt="DSClaw" className="h-5 w-auto shrink-0" />
